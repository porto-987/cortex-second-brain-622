    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <TabsContent value="analytics" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Analytics et Métriques IA</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-purple-50 rounded">
                  <BarChart3 className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                  <h4 className="font-semibold">Précision Modèle</h4>
                  <p className="text-2xl font-bold text-purple-600">94.7%</p>
                </div>
                <div className="text-center p-4 bg-blue-50 rounded">
                  <Target className="w-8 h-8 text-blue-600 mx-auto mb-2" />
                  <h4 className="font-semibold">Rappel</h4>
                  <p className="text-2xl font-bold text-blue-600">91.2%</p>
                </div>
                <div className="text-center p-4 bg-green-50 rounded">
                  <Zap className="w-8 h-8 text-green-600 mx-auto mb-2" />
                  <h4 className="font-semibold">Score F1</h4>
                  <p className="text-2xl font-bold text-green-600">92.9%</p>
                </div>
              </div>
            </CardContent>
          </Card>
